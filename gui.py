...
class LyricsApp:
    def __init__(self, root):
        ...
        self.timeline_canvas.grid(row=0, column=0, sticky="ew", padx=26, pady=10)
        ...
        # Previous button
        self.prev_button = tk.Button(button_frame, text="\u23EE", bg=BG_COLOR, fg=COLOR_ACTIVE_FG, font=(FONT_FAMILY, 16), 
        ...
        # Play/Pause button
        self.play_pause_button = tk.Button(button_frame, text="\u23F8", bg=BG_COLOR, fg=COLOR_ACTIVE_FG, font=(FONT_FAMILY, 16), 
                                          borderwidth=0, relief=tk.FLAT, highlightthickness=0,
                                          activebackground="#24243e", activeforeground=COLOR_ACTIVE_FG)
        ...
        self.play_pause_button.grid(row=0, column=1, sticky="ew", padx=5)

        # Next button
        self.next_button = tk.Button(button_frame, text="\u23ED", bg=BG_COLOR, fg=COLOR_ACTIVE_FG, font=(FONT_FAMILY, 16), 
                                    borderwidth=0, relief=tk.FLAT, highlightthickness=0,
                                    activebackground="#24243e", activeforeground=COLOR_ACTIVE_FG)
        ...
        # Draw initial timeline progress (25%)
        self.draw_timeline_progress(0.25)
